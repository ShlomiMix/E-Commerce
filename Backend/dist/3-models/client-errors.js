...
exports.UnauthorizedError = exports.ValidationError = exports.ResourceNotFoundError = exports.QueryNotFound = exports.RouteNotFoundError = void 0;
...
class QueryNotFound extends ClientError {
    constructor(query) {
        super(`query ${query} is not exists`, enums_1.StatusCode.NotFound);
    }
}
exports.QueryNotFound = QueryNotFound;
